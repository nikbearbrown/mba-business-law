...
**Exercise 3-LLM-1.** Paste the following prompt into a large language model of your choice:

> "You are advising a newly appointed chief ethics officer at a mid-sized publicly-traded firm. The firm has a code of conduct, a whistleblower hotline, and an annual compliance training program. In the most recent employee survey, 38 percent of respondents said they would not report misconduct they witnessed because they did not believe reporting would be anonymous or lead to any consequence. What are the three most likely structural causes of this survey result, and what specific operational changes would you recommend to address each one? Be concrete — name the change, the mechanism by which it produces improvement, and how you would measure whether the improvement occurred."

Evaluate the LLM's response against the chapter's framework. Did it identify the tone-at-the-top mechanism? Did it distinguish between the stated whistleblower policy and the operative culture? Did it recommend changes to the incentive structure or only to communications and training? Write a 400-word evaluation.

**Exercise 3-LLM-2.** Paste the following prompt into two different large language models and compare their outputs:

> "The Wells Fargo unauthorized-account scandal involved approximately 3.5 million fraudulent accounts opened without customer consent between 2011 and 2016. Identify the specific failure at each level of the corporate governance apparatus — the board, the audit committee, the internal compliance function, and the external auditor — that allowed the misconduct to continue for approximately five years before public disclosure. For each failure, identify what a properly functioning version of that governance layer would have done differently."

Compare the two responses. Which response better distinguishes structural failures from individual failures? Which response better identifies the compensation-incentive mechanism? Write a 300-word comparative analysis.

**Exercise 3-LLM-3 (synthesis).** You are the chief ethics officer at Westchester, the hypothetical regional health-insurance carrier described in the integration section of this chapter. The compensation-incentive gap the chapter identified — claims-handlers paid on resolution speed, which pressures premature denial — is real, documented, and has been delivered to the audit committee. The CEO has received the report and has not yet responded.
